-- Script de création des tables avec la nouvelle structure JSON
USE katapult_db;
...
-- Table des candidatures avec structure JSON
...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    type ENUM('info', 'success', 'warning', 'error', 'candidature_soumise', 'candidature_evaluee') DEFAULT 'info',
    reference JSON,
